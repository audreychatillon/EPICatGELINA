...
void run()
{
	...
	TFile * f82_1065 = new TFile("results/Histo_V8-2_1065mbar_750V_9.root","read");
	...
	TH2F * h82_1040_discri[nA];
	TH2F * h82_1065_discri[nA];
	TH2F * h82_1075_discri[nA];
	TH2F * h82_1210_discri[nA];
	TH2F * h82_1370_discri[nA];
	TH2F * h82_1380_discri[nA];

	TLatex t82_1040;  t82_1040.SetNDC();  t82_1040.SetTextSize(0.05);  t82_1040.SetTextColor(kBlue);
	TLatex t82_1065;  t82_1065.SetNDC();  t82_1065.SetTextSize(0.05);  t82_1065.SetTextColor(kCyan+1);
	TLatex t82_1075;  t82_1075.SetNDC();  t82_1075.SetTextSize(0.05);  t82_1075.SetTextColor(kCyan+3);
	TLatex t82_1210;  t82_1210.SetNDC();  t82_1210.SetTextSize(0.05);  t82_1210.SetTextColor(8);
	TLatex t82_1370;  t82_1370.SetNDC();  t82_1370.SetTextSize(0.05);  t82_1370.SetTextColor(kRed+1);
	TLatex t82_1380;  t82_1380.SetNDC();  t82_1380.SetTextSize(0.05);  t82_1380.SetTextColor(kMagenta);

	for(int a = 0 ; a < nA ; a++){

		cout << "index " << a << " : anode = " << anode[a] << endl;
		...
		h82_1380_Q1[a]->Scale(61751./27868.);
		...
		h82_1040_Q1[a]->Scale(61751./19333.);
		...
		h82_1210_Q1[a]->SetLineWidth(2);
		h82_1210_Q1[a]->SetLineColor(8);
		h82_1210_Q1[a]->Rebin(20);
		h82_1210_Q1[a]->Scale(61751./42866.);
		...
		h82_1370_Q1[a]->Scale(61751./16939.);
		...
		h82_1075_Q1[a]->SetLineColor(kCyan+3);
		h82_1075_Q1[a]->Rebin(20);
		h82_1075_Q1[a]->SetDirectory(0);
		h82_1075_Q1[a]->ls();

		sprintf(name,"Q1_A%i_9",anode[a]);
		h82_1065_Q1[a] = (TH1F*)f82_1065->Get(name);
		h82_1065_Q1[a]->ls();
		sprintf(name,"Q1_A%i_P1065mbar_750V",anode[a]);
		h82_1065_Q1[a]->SetTitle(name);
		h82_1065_Q1[a]->SetName(name);
		h82_1065_Q1[a]->SetLineColor(kCyan+1);
		h82_1065_Q1[a]->Rebin(40);
		h82_1065_Q1[a]->Scale(0.5*61751./3269.);
		h82_1065_Q1[a]->SetDirectory(0);
		h82_1065_Q1[a]->ls();
		...
		h82_1065_Q1[a]->Draw("hist same");		
			
		t82_1040.DrawLatex(0.4,0.45,"1040 mbar, 550 V");
		t82_1210.DrawLatex(0.4,0.40,"1210 mbar, 680 V");
		t82_1370.DrawLatex(0.4,0.35,"1370 mbar, 720 V");
		t82_1380.DrawLatex(0.4,0.30,"1380 mbar, 650 V");
		t82_1075.DrawLatex(0.4,0.25,"???? mbar, ??? V");
		t82_1065.DrawLatex(0.4,0.20,"???? mbar, ??? V");
		...
		h82_1210_discri[a] = (TH2F*)f82_1210->Get(name);
		...
		h82_1040_discri[a] = (TH2F*)f82_1040->Get(name);
		...
		h82_1380_discri[a] = (TH2F*)f82_1380->Get(name);
		...
		h82_1370_discri[a] = (TH2F*)f82_1370->Get(name);
		...
		h82_1075_discri[a] = (TH2F*)f82_1075->Get(name);
		...
		sprintf(name,"discri_A%i_9",anode[a]);
		h82_1065_discri[a] = (TH2F*)f82_1065->Get(name);
		sprintf(name,"discri_A%i_P1065mbar_750V",anode[a]);
		h82_1065_discri[a]->SetTitle(name);
		h82_1065_discri[a]->SetName(name);
		h82_1065_discri[a]->SetLineColor(kCyan+2);
		h82_1065_discri[a]->SetDirectory(0);
		h82_1065_discri[a]->GetXaxis()->SetRangeUser(7000,500000);
		h82_1065_discri[a]->GetYaxis()->SetRangeUser(0,3.5);
		...
		can_discri[a]->cd(3); gPad->SetGridx(); gPad->SetGridy(); gPad->SetLogz(); gPad->SetLogx(); h82_1075_discri[a]->Draw("colz");
		can_discri[a]->cd(5); gPad->SetGridx(); gPad->SetGridy(); gPad->SetLogz(); gPad->SetLogx(); h82_1065_discri[a]->Draw("colz");
		can_discri[a]->cd(2); gPad->SetGridx(); gPad->SetGridy(); gPad->SetLogz(); gPad->SetLogx(); h82_1210_discri[a]->Draw("colz");
		can_discri[a]->cd(5); gPad->SetGridx(); gPad->SetGridy(); gPad->SetLogz(); gPad->SetLogx(); h82_1370_discri[a]->Draw("colz");
		can_discri[a]->cd(4); gPad->SetGridx(); gPad->SetGridy(); gPad->SetLogz(); gPad->SetLogx(); h82_1380_discri[a]->Draw("colz");
	}

	TH1F * h82clone_1040_Q1 = (TH1F*)h82_1040_Q1[3]->Clone();
	TH1F * h82clone_1075_Q1 = (TH1F*)h82_1075_Q1[3]->Clone();
	TH1F * h82clone_1065_Q1 = (TH1F*)h82_1065_Q1[3]->Clone();
	...
	TH1F * h82clonezoom_1040_Q1 = (TH1F*)h82_1040_Q1[3]->Clone();
	TH1F * h82clonezoom_1075_Q1 = (TH1F*)h82_1075_Q1[3]->Clone();
	TH1F * h82clonezoom_1065_Q1 = (TH1F*)h82_1075_Q1[3]->Clone();
	TH1F * h82clonezoom_1210_Q1 = (TH1F*)h82_1210_Q1[3]->Clone();
	TH1F * h82clonezoom_1370_Q1 = (TH1F*)h82_1370_Q1[3]->Clone();
	TH1F * h82clonezoom_1380_Q1 = (TH1F*)h82_1380_Q1[3]->Clone();

	TLatex t82sandia_1040;  t82sandia_1040.SetNDC();  t82sandia_1040.SetTextSize(0.035);  t82sandia_1040.SetTextColor(kBlue);
	TLatex t82sandia_1065;  t82sandia_1065.SetNDC();  t82sandia_1065.SetTextSize(0.035);  t82sandia_1065.SetTextColor(kCyan+1);
	TLatex t82sandia_1075;  t82sandia_1075.SetNDC();  t82sandia_1075.SetTextSize(0.035);  t82sandia_1075.SetTextColor(kCyan+3);
	TLatex t82sandia_1210;  t82sandia_1210.SetNDC();  t82sandia_1210.SetTextSize(0.035);  t82sandia_1210.SetTextColor(8);
	TLatex t82sandia_1370;  t82sandia_1370.SetNDC();  t82sandia_1370.SetTextSize(0.035);  t82sandia_1370.SetTextColor(kRed+1);
	TLatex t82sandia_1380;  t82sandia_1380.SetNDC();  t82sandia_1380.SetTextSize(0.035);  t82sandia_1380.SetTextColor(kMagenta);

	TCanvas * canSANDIA = new TCanvas("SANDIA","SANDIA",0,0,1000,1000);
	canSANDIA->cd(); gPad->SetLogy(); 
	h82clone_1040_Q1->Draw("hist");        
	h82clone_1040_Q1->GetXaxis()->SetRangeUser(15000,400000);        
	...
	t82sandia_1040.DrawLatex(0.13,0.90,"1040 mbar, 550 V");
	t82sandia_1210.DrawLatex(0.13,0.85,"1210 mbar, 680 V");
	t82sandia_1370.DrawLatex(0.13,0.70,"1370 mbar, 720 V");
	t82sandia_1380.DrawLatex(0.13,0.65,"1380 mbar, 650 V");
	t82sandia_1075.DrawLatex(0.13,0.60,"1075 mbar, 720 V");
	t82sandia_1065.DrawLatex(0.13,0.55,"1065 mbar, 750 V");
	...
	h82clonezoom_1040_Q1->Draw("hist");        
	h82clonezoom_1040_Q1->GetXaxis()->SetRangeUser(15000,40000);        
	h82clonezoom_1040_Q1->GetXaxis()->SetTitle("total charge");        
	h82clonezoom_1040_Q1->GetXaxis()->SetLabelSize(0.065);
	h82clonezoom_1040_Q1->GetXaxis()->SetLabelSize(0.065);
	h82clonezoom_1210_Q1->Draw("hist same");
	h82clonezoom_1370_Q1->Draw("hist same");
	h82clonezoom_1380_Q1->Draw("hist same");
	h82clonezoom_1075_Q1->Draw("hist same");
	h82clonezoom_1065_Q1->Draw("hist same");
}
